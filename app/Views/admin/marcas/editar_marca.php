<section class="container-xl col-7 text-center mt-4">
    <form method="post" action="<?php echo base_url('dashboard/marcas/actualizar'); ?>" autocomplete="off">
        <h1 class="fs-2">Editar Marca</h1>
        <div class="form__container d-flex justify-content-center align-items-center my-4">
            <div class="form__group col-7">
                ...
                <div class="position-relative" style="flex-grow:1;">
                    <input class="mx-0 position w-100 form-input" autocomplete="off" name="nombre" id="nombre" value="<?php echo $marca['nombre']; ?>" require type="text" placeholder=" ">
                ...
                <a class="text-black" href="<?php echo base_url('dashboard/marcas'); ?>" style="font-size: 15px; font-weight:500">Regresar</a>
            </div>
        </div>
    </form>
</section>