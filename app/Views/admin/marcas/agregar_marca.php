<section class="container-xl col-7 text-center mt-4">
    <form method="post" action="<?php echo base_url('dashboard/marcas/insertar'); ?>" autocomplete="off">
        <h1 class="fs-2">Agregar Marca</h1>
        <div class="form__container d-flex justify-content-center align-items-center my-4">
            <div class="form__group col-7">
                ...
                <button class="btn-enviar-datos mb-3 text-uppercase w-100">Agregar marca</button>
