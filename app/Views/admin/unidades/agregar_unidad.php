<section class="container-xl col-7 text-center mt-4">
    <form method="post" action="<?php echo base_url('dashboard/unidades/insertar'); ?>" autocomplete="off">
        <h1 class="fs-2">Agregar Unidad</h1>
        <div class="form__container d-flex justify-content-center align-items-center my-4">
            <div class="form__group col-7">
                ...
                <div class="position-relative" style="flex-grow:1;">
                    <input class="mx-0 position w-100 form-input" autocomplete="off" name="nombreCorto" id="nombreCorto" require type="text" placeholder=" ">
                ...
                <button class="btn-enviar-datos mb-3 text-uppercase w-100">Agregar Unidad</button>
